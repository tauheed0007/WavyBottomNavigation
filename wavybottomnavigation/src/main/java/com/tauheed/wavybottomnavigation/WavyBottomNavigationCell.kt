...
import com.tauheed.wavybottomnavigation.databinding.WavyNavigationCellBinding
...
@Suppress("unused")
class WavyBottomNavigationCell @JvmOverloads constructor(
    context: Context,
    ...
    private val binding = DataBindingUtil.inflate<WavyNavigationCellBinding>(
        LayoutInflater.from(context),
        R.layout.wavy_navigation_cell,
        this,
        true
    )
